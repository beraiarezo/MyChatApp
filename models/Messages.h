...
class Messages
{
  public:
    ...
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getSenderId() const noexcept;
    ///Set the value of the column sender_id
    void setSenderId(const std::string &pSenderId) noexcept;
    void setSenderId(std::string &&pSenderId) noexcept;
