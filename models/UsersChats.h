...
class UsersChats
{
  public:
    ...
    using PrimaryKeyType = std::tuple<std::string,std::string>;//chat_id,user_id
     ...
     */
    explicit UsersChats(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UsersChats(const Json::Value &pJson) noexcept(false);
     ...
     */
    UsersChats(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<UsersChats>;
    friend drogon::orm::BaseBuilder<UsersChats, true, true>;
    friend drogon::orm::BaseBuilder<UsersChats, true, false>;
    friend drogon::orm::BaseBuilder<UsersChats, false, true>;
    friend drogon::orm::BaseBuilder<UsersChats, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UsersChats>;
#endif
