...
class UsersGroups
{
  public:
    ...
    using PrimaryKeyType = std::tuple<std::string,std::string>;//user_id,group_id
     ...
     */
    explicit UsersGroups(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UsersGroups(const Json::Value &pJson) noexcept(false);
     ...
     */
    UsersGroups(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<UsersGroups>;
    friend drogon::orm::BaseBuilder<UsersGroups, true, true>;
    friend drogon::orm::BaseBuilder<UsersGroups, true, false>;
    friend drogon::orm::BaseBuilder<UsersGroups, false, true>;
    friend drogon::orm::BaseBuilder<UsersGroups, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UsersGroups>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where user_id = $1 and group_id = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where user_id = $1 and group_id = $2";
        return sql;
    }
