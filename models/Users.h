...
class Users
{
  public:
    ...
    const bool &getValueOfIsBanned() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<bool> &getIsBanned() const noexcept;
    ///Set the value of the column is_banned
    void setIsBanned(const bool &pIsBanned) noexcept;
